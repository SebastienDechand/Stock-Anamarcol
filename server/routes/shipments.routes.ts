...
import { requireAuth, requireHotline, requireAdmin } from '../middleware/auth/auth.middleware';
...
router.get('/archives/:id/download', requireAdmin, shipmentsController.downloadArchive);
