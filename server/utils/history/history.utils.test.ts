...
import { logItemCreate, logItemDelete, logItemChanges } from './history.utils';
...
describe('history.utils', () => {
  ...
  describe('logItemDelete', () => {
    ...
    it('should not throw on DB error', async () => {
      ...
      await expect(logItemDelete('item456', 'Test', 'admin')).resolves.toBeUndefined();
    });
  });
  // #endregion
  ...
  describe('logItemChanges', () => {
    it('should track quantity change', async () => {
      ...
      await logItemChanges('item789', { quantity: 10 }, { quantity: 5 }, 'admin');
    ...
    it('should ignore untracked fields', async () => {
      await logItemChanges('item789', { randomField: 'old' }, { randomField: 'new' }, 'admin');
