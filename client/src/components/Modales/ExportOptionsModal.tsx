...
interface Props {
  onClose: () => void;
  /** Modal title – defaults to "Exporter les articles" */
  title?: string;
  /** Custom export handler. When provided the modal delegates all
   *  data-fetching & exporting to the caller. When omitted the modal
   *  falls back to the built-in articles export. */
  onExport?: (format: ExportFormat) => Promise<void>;
  /** Restrict visible format choices. Defaults to all. */
