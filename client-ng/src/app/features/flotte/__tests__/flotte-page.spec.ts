...
import { FlottePage } from '../flotte-page';
...
describe('FlottePage', () => {
  let component: FlottePage;
  let facade: VehiclesFacade;

  beforeEach(async () => {
    TestBed.overrideComponent(FlottePage, { set: { template: '', imports: [] } });
    ...
    const fixture = TestBed.createComponent(FlottePage);
