...
import { initialClientFilesState } from '../../fiches-clients/store/client-files.state';
...
describe('EnvoisPage', () => {
  ...
  beforeEach(async () => {
    TestBed.overrideComponent(EnvoisPage, { set: { template: '', imports: [] } });
    ...
    const fixture = TestBed.createComponent(EnvoisPage);
