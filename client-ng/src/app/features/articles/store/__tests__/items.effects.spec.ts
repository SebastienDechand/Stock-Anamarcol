...
describe('ItemsEffects', () => {
  ...
  describe('createItem$', () => {
    it('should dispatch createItemSuccess and show success toast', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('TOAST.ARTICLE_ADDED');
    ...
    it('should dispatch createItemFailure and show error toast on API error', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('TOAST.ARTICLE_ADD_ERROR');
    });
  ...
  describe('updateItem$', () => {
    it('should dispatch updateItemSuccess and show success toast', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('TOAST.ARTICLE_UPDATED');
    });
    ...
    it('should dispatch updateItemFailure and show error toast on API error', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('TOAST.ARTICLE_UPDATE_ERROR');
    });
  });
  ...
  describe('deleteItem$', () => {
    it('should dispatch deleteItemSuccess and show success toast', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('TOAST.ARTICLE_DELETED');
    });
    ...
    it('should dispatch deleteItemFailure and show error toast on API error', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('TOAST.ARTICLE_DELETE_ERROR');
    });
  ...
  describe('updateQuantite$', () => {
    it('should dispatch updateQuantiteSuccess and show success toast', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('TOAST.ARTICLE_QTY_UPDATED');
    });
  ...
  describe('uploadPicture$', () => {
    it('should dispatch uploadItemPictureSuccess and show success toast', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('TOAST.ARTICLE_IMAGE_UPDATED');
    });
    ...
    it('should dispatch uploadItemPictureFailure and show error toast on API error', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('TOAST.ARTICLE_IMAGE_ERROR');
    });
  ...
  describe('prepaBatch$', () => {
    it('should dispatch prepaBatchSuccess then refetch items for prepaCG increment', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('ARTICLES.PREPA_BATCH_CG_INCREMENTED', {
        count: 3,
      });
    });
    ...
    it('should dispatch prepaBatchSuccess then refetch items for non-prepaCG decrement', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('ARTICLES.PREPA_BATCH_TPV_DECREMENTED', {
        count: 5,
      });
    });
    ...
    it('should dispatch only prepaBatchSuccess and show error toast on API error', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('TOAST.ARTICLE_BATCH_ERROR');
    });
  });
